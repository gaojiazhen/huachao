layui.use(['form','layer','table','laytpl','common'],function(){	
	...
	function Action(){
		...
		common.ajax(listBaseDepartment, 'post', 'json', unitParam, function (dres) {
			...
			common.ajax(listRetireWorkerBiennialChange, 'post', 'json', userParam, function (ures) {
				var tableIns = table.render({
					...
					cols : [[
						...
						{field: 'PREVIOUS_YEAR_CADRE', title: '上年12月底<br>退休工人总数', width:130,minWidth:130, align:"center", rowspan:2},
						{field: 'THIS_YEAR_RETIRE', title: '本年度内办理<br>退休手续工人数', width:130,minWidth:130, align:"center", rowspan:2},
						{field: 'THIS_YEAR_DECEASED', title: '本年度内<br>去世退休工人数', width:130,minWidth:130, align:"center", rowspan:2},
						{title: '本年12月底<br>应有退休工人数', width:130,minWidth:130, align:"center", rowspan:2, templet: function(d){
							return Number(d.PREVIOUS_YEAR_CADRE) + Number(d.THIS_YEAR_RETIRE) - Number(d.THIS_YEAR_DECEASED);
						}},
						{title: '本年12月底<br>实有退休工人数', width:130,minWidth:130, align:"center", rowspan:2, templet: function(d){
							return Number(d.PREVIOUS_YEAR_CADRE) + Number(d.THIS_YEAR_RETIRE) - Number(d.THIS_YEAR_DECEASED);
						}},
						{title: '其中', width:210,minWidth:210, align:"center", colspan:3},
						],[
						{field: 'IN_BEIJING', title: '在京', width:60,minWidth:60, align:"center"},
						{field: 'COMMUNIST', title: '中共党员', width:90,minWidth:90, align:"center"},
						{field: 'FOUNDING_STATE_WORK', title: '建国前参加革命工作', width:160,minWidth:160, align:"center"}
					]]
				});
				form.render();
			});
	...
	$("#excel").click(function(){
	    $("#formid").attr("action",excelRetireWorkerBiennialChange).trigger("submit");
	});
})