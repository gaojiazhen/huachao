layui.use(['form', 'layer', 'common', 'upload'],function(){
	...
	$("#download_template").click(function(){
	    window.location.href="离退休人员登记数据导入模板.xls";
	});
	//关闭
	...
	//附件上传
	var dataParam = {unit_id: function(){return $("#unit_id").val();}};
	...
	upload.render({
		...
		choose: function(obj){
			...
			if(res.success){
				...
				$(".layui-fluid").html(res.message).attr("style","color:#FF5722;");
			}
		},
		error: function() {
